          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center gap-4">
              <motion.img
					...
					/>
              <h1 className="text-2xl font-bold text-gray-800">Homiee Dashboard</h1>
            </div>
            <div className="flex items-center gap-4">
              <span className="text-gray-600">Welcome, {user.firstName || user.name}</span>
              <button
                onClick={()=>{
                    logout();
                    router.push("/");
                ...
                className="text-gray-600 hover:text-[#f38406] transition-colors"
              >
                Logout
              </button>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-600">
                <span className="font-medium">Languages:</span> {user.languageSpoken?.length || 0} selected
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-600">
                <span className="font-medium">Alcohol:</span> {user.alcoholUsage || "Not set"}
              </p>
              <p className="text-gray-600">
