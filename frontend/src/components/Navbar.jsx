		...
		>
			...
			>
				...
				<motion.h2
					...
					onClick={() => router.push("/")}
					className="hidden md:block  text-[#1c150d] text-2xl font-bold leading-tight tracking-[-0.02em] font-heading bg-gradient-to-r from-[#1c150d] to-[#3a3a3a] bg-clip-text cursor-pointer"
				>
					Homiee
				</motion.h2>
			</motion.div>
